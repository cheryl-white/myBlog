(() => {
  ...
  function ce(l, e) {
    return l === e
      ? !0
      : (gt || (gt = document.createElement("a")),
        (gt.href = e),
        l === gt.href);
  }
  function Hl(l) {
  ...
  var xt =
    typeof window < "u"
      ...
      : typeof globalThis < "u"
        ...
        : global;
  var Ct = class l {
    _listeners = "WeakMap" in xt ? new WeakMap() : void 0;
    _observer = void 0;
    options;
    constructor(e) {
      this.options = e;
  ...
  Ct.entries = "WeakMap" in xt ? new WeakMap() : void 0;
  var Rl = !1;
  function Sl() {
    Rl = !0;
  }
  ...
  function dt() {
    ...
    do {
      ...
      for (j(null), se.length = 0, oe = 0; Ce.length; ) Ce.pop()();
  ...
  function zl(l, e, t, s, a, i, r, n, c, C, u, A) {
    let o = l.length,
      d = i.length,
      g = o,
      I = {};
    ...
    for (g = d; g--; ) {
      let N = A(a, i, g),
        R = t(N),
        G = r.get(R);
      (G ? s && h.push(() => G.p(N, e)) : ((G = C(R, N)), G.c()),
        f.set(R, (Q[g] = G)),
        R in I && p.set(R, Math.abs(g - I[R])));
    }
    let y = new Set(),
      q = new Set();
    function z(N) {
      (k(N, 1), N.m(n, u), r.set(N.key, N), (u = N.first), d--);
    }
    for (; o && d; ) {
      let N = Q[d - 1],
        R = l[o - 1],
  ...
  function _e(l, e, t) {
    ...
    (s && s.m(e, t),
      Ae(() => {
        let i = l.$$.on_mount.map(Bt).filter(ut);
        (l.$$.on_destroy ? l.$$.on_destroy.push(...i) : v(i),
          (l.$$.on_mount = []));
      }),
      a.forEach(Ae));
  }
  ...
  function ca(l, e) {
    (l.$$.dirty[0] === -1 && (se.push(l), Tl(), l.$$.dirty.fill(0)),
      (l.$$.dirty[(e / 31) | 0] |= 1 << (e % 31)));
  }
  function K(l, e, t, s, a, i, r = null, n = [-1]) {
    let c = te;
    j(l);
    let C = (l.$$ = {
      fragment: null,
    ...
    if (
      ((C.ctx = t
        ? t(l, e.props || {}, (A, o, ...d) => {
            let g = d.length ? d[0] : o;
            return (
              C.ctx &&
                a(C.ctx[A], (C.ctx[A] = g)) &&
                (!C.skip_bound && C.bound[A] && C.bound[A](g), u && ca(l, A)),
              o
            );
          })
        : []),
      ...
      (e.intro && k(l.$$.fragment), _e(l, e.target, e.anchor), Vl(), dt());
    }
    j(c);
  }
  var ga;
  typeof HTMLElement == "function" &&
    (ga = class extends HTMLElement {
      ...
      async connectedCallback() {
        if (((this.$$cn = !0), !this.$$c)) {
          ...
          for (let a of this.attributes) {
            let i = this.$$g_p(a.name);
            i in this.$$d ||
              (this.$$d[i] = Et(i, a.value, this.$$p_d, "toProp"));
          }
          ...
          let s = () => {
            ...
            for (let a in this.$$p_d)
              if (
                ...
                let i = Et(a, this.$$d[a], this.$$p_d, "toAttribute");
                i == null
                  ? this.removeAttribute(this.$$p_d[a].attribute || a)
                  : this.setAttribute(this.$$p_d[a].attribute || a, i);
              }
            this.$$r = !1;
          };
          (this.$$c.$$.after_update.push(s), s());
          for (let a in this.$$l)
            for (let i of this.$$l[a]) {
              let r = this.$$c.$on(a, i);
              this.$$l_u.set(i, r);
            }
          this.$$l = {};
      ...
      attributeChangedCallback(l, e, t) {
        this.$$r ||
          ((l = this.$$g_p(l)),
          (this.$$d[l] = Et(l, t, this.$$p_d, "toProp")),
  ...
  function bt(l, e = {}) {
    ...
    for (; D(a.charCodeAt(i)) && i < 9; ) i++;
    if (i > 1 && i < 9) {
      if (((t.language = s.slice(0, i)), i < 4)) {
        let n = 0;
        for (
          ;
          a.charCodeAt(i) === 45 &&
          ...
          (t.extendedLanguageSubtags.push(s.slice(i + 1, i + 4)),
            (i += 4),
            n++);
        }
      }
      for (
        a.charCodeAt(i) === 45 &&
          ...
          D(a.charCodeAt(i + 4)) &&
          !D(a.charCodeAt(i + 5)) &&
          ((t.script = s.slice(i + 1, i + 5)), (i += 5)),
          a.charCodeAt(i) === 45 &&
            (D(a.charCodeAt(i + 1)) &&
            D(a.charCodeAt(i + 2)) &&
            !D(a.charCodeAt(i + 3))
              ? ((t.region = s.slice(i + 1, i + 3)), (i += 3))
              : le(a.charCodeAt(i + 1)) &&
                le(a.charCodeAt(i + 2)) &&
                le(a.charCodeAt(i + 3)) &&
                !le(a.charCodeAt(i + 4)) &&
                ((t.region = s.slice(i + 1, i + 4)), (i += 4)));
        a.charCodeAt(i) === 45;
      ) {
        let n = i + 1,
          c = n;
        for (; P(a.charCodeAt(c)); ) {
          if (c - n > 7)
            return r(c, 1, "Too long variant, expected at most 8 characters");
          c++;
        }
        if (c - n > 4 || (c - n > 3 && le(a.charCodeAt(n))))
          (t.variants.push(s.slice(n, c)), (i = c));
        else break;
      }
      for (
        ;
        ...
        (t.extensions.push({
          singleton: s.charAt(i + 1),
          extensions: s.slice(i + 3, n).split("-"),
        }),
          (i = n));
      }
    } else i = 0;
    if (
      (i === 0 && a.charCodeAt(i) === 120) ||
      (a.charCodeAt(i) === 45 && a.charCodeAt(i + 1) === 120)
    ) {
      i = i ? i + 2 : 1;
      let n = i;
      for (; a.charCodeAt(n) === 45 && P(a.charCodeAt(n + 1)); ) {
        let c = i + 1;
        for (n = c; P(a.charCodeAt(n)); ) {
          if (n - c > 7)
            return r(
              n,
              5,
        ...
        (t.privateuse.push(s.slice(i + 1, n)), (i = n));
      }
    }
    if (i !== s.length) return r(i, 6, "Found superfluous content after tag");
    return t;
    function r(n, c, C) {
      return (e.warning && e.warning(C, c, n), e.forgiving ? t : Kl());
    }
  }
  function Kl() {
    return {
  ...
  function Ca(l) {
    ...
    return {
      ...
      m(n, c) {
        (r && r.m(n, c), x(n, e, c), x(n, t, c), m(t, s), m(t, a), m(t, i));
      },
      p(n, c) {
        n[0]
          ? r || ((r = ql(n)), r.c(), r.m(e.parentNode, e))
          : r && (r.d(1), (r = null));
      },
      d(n) {
        (n && (B(e), B(t)), r && r.d(n));
    ...
    return {
      ...
      p(g, I) {
        (g[0]
          ? o
            ? o.p(g, I)
            : ((o = $l(g)), o.c(), o.m(e.parentNode, e))
          : o && (o.d(1), (o = null)),
          I & 2 && i !== (i = g[1].meta?.title + "") && H(r, i),
          I & 2 && n !== (n = g[1].meta?.url || g[1].url) && _(a, "href", n),
          I & 2 && u !== (u = g[1].excerpt + "") && (C.innerHTML = u),
          g[2].length
            ? d
              ? d.p(g, I)
              : ((d = ts(g)), d.c(), d.m(t, null))
            : d && (d.d(1), (d = null)));
      },
      d(g) {
        (g && (B(e), B(t)), o && o.d(g), d && d.d());
      },
    };
  }
  function ql(l) {
    ...
    return {
      c() {
        ((e = F("img")),
          ...
          ce(e.src, (t = l[1].meta?.image)) || _(e, "src", t),
      ...
      p(a, i) {
        (i & 2 && !ce(e.src, (t = a[1].meta?.image)) && _(e, "src", t),
          i & 2 &&
      ...
      p(a, i) {
        if (i & 4) {
          ...
          for (r = 0; r < t.length; r += 1) {
            let n = Pl(a, t, r);
            s[r] ? s[r].p(n, i) : ((s[r] = ls(n)), s[r].c(), s[r].m(e, null));
          }
    ...
    return {
      c() {
        ((e = F("li")),
          ...
          _(e, "data-pagefind-ui-meta", (c = l[9])));
      },
      m(C, u) {
        (x(C, e, u), m(e, s), m(e, a), m(e, r), m(e, n));
      },
      p(C, u) {
        (u & 4 && t !== (t = C[9].replace(/^(\w)/, ss) + "") && H(s, t),
          u & 4 && i !== (i = C[10] + "") && H(r, i),
          u & 4 && c !== (c = C[9]) && _(e, "data-pagefind-ui-meta", c));
      },
      d(C) {
        C && B(e);
      },
  ...
  function Aa(l, e, t) {
    let { show_images: s = !0 } = e,
      ...
      { result: i = { data: async () => {} } } = e,
      r = ["title", "image", "image_alt", "url"],
      n,
      c = [],
      C = (o, d) => {
        if (
          ...
          return o;
        try {
          return new URL(o, new URL(d || "/", "https://p")).pathname;
        } catch {
          return o;
        }
      },
      u = async (o) => {
        (t(1, (n = await o.data())),
          ...
          t(2, (c = Object.entries(n.meta).filter(([d]) => !r.includes(d)))));
      },
      A = (o = 30) => ". ".repeat(Math.floor(10 + Math.random() * o));
    return (
      (l.$$set = (o) => {
        ("show_images" in o && t(0, (s = o.show_images)),
          "process_result" in o && t(4, (a = o.process_result)),
          "result" in o && t(5, (i = o.result)));
      }),
      (l.$$.update = () => {
        l.$$.dirty & 32 && u(i);
      }),
  ...
  function _a(l) {
    ...
    return {
      ...
      p(n, c) {
        n[0]
          ? r || ((r = ns(n)), r.c(), r.m(e.parentNode, e))
          : r && (r.d(1), (r = null));
      },
      d(n) {
        (n && (B(e), B(t)), r && r.d(n));
  ...
  function ba(l) {
    let e,
      ...
      d = S(l[3]),
      g = [];
    for (let Q = 0; Q < d.length; Q += 1) g[Q] = us(rs(l, d, Q));
    ...
    return {
      c() {
        (A && A.c(),
          ...
          o && o.c(),
          (C = X()));
        for (let Q = 0; Q < g.length; Q += 1) g[Q].c();
        ((u = X()),
          I && I.c(),
      ...
      p(Q, f) {
        if (
          (Q[0]
            ? A
              ? A.p(Q, f)
              : ((A = cs(Q)), A.c(), A.m(e.parentNode, e))
            : A && (A.d(1), (A = null)),
          f & 2 && i !== (i = Q[1].meta?.title + "") && H(r, i),
          f & 2 && n !== (n = Q[1].meta?.url || Q[1].url) && _(a, "href", n),
          Q[4]
            ? o
              ? o.p(Q, f)
              : ((o = os(Q)), o.c(), o.m(t, C))
          ...
          for (p = 0; p < d.length; p += 1) {
            let h = rs(Q, d, p);
            g[p] ? g[p].p(h, f) : ((g[p] = us(h)), g[p].c(), g[p].m(t, u));
          }
        ...
        Q[2].length
          ? I
            ? I.p(Q, f)
            : ((I = Cs(Q)), I.c(), I.m(t, null))
          : I && (I.d(1), (I = null));
      },
      d(Q) {
        (Q && (B(e), B(t)), A && A.d(Q), o && o.d(), $(g, Q), I && I.d());
      },
    };
  }
  function ns(l) {
    ...
    return {
      c() {
        ((e = F("div")),
          ...
          _(c, "class", "pagefind-ui__result-excerpt svelte-4xnkmf"),
      ...
      p(u, A) {
        (A & 8 && a !== (a = u[15].title + "") && H(i, a),
          A & 8 && r !== (r = u[15].url) && _(s, "href", r),
          A & 8 && C !== (C = u[15].excerpt + "") && (c.innerHTML = C));
      },
      d(u) {
        u && B(e);
      },
  ...
  function Cs(l) {
    let e,
      t = S(l[2]),
      s = [];
    for (let a = 0; a < t.length; a += 1) s[a] = Is(is(l, t, a));
    return {
      c() {
        e = F("ul");
        for (let a = 0; a < s.length; a += 1) s[a].c();
      ...
      p(a, i) {
        if (i & 4) {
          ...
          for (r = 0; r < t.length; r += 1) {
            let n = is(a, t, r);
            s[r] ? s[r].p(n, i) : ((s[r] = Is(n)), s[r].c(), s[r].m(e, null));
          }
          for (; r < s.length; r += 1) s[r].d(1);
          s.length = t.length;
        }
    ...
    return {
      c() {
        ((e = F("li")),
          ...
          _(e, "data-pagefind-ui-meta", (c = l[11])));
      },
      m(C, u) {
        (x(C, e, u), m(e, s), m(e, a), m(e, r), m(e, n));
      },
      p(C, u) {
        (u & 4 && t !== (t = C[11].replace(/^(\w)/, ds) + "") && H(s, t),
          u & 4 && i !== (i = C[12] + "") && H(r, i),
          u & 4 && c !== (c = C[11]) && _(e, "data-pagefind-ui-meta", c));
      },
      d(C) {
        C && B(e);
      },
  ...
  function ma(l, e, t) {
    let { show_images: s = !0 } = e,
      ...
      u = !1,
      A = (g, I) => {
        if (g.length <= I) return g;
        let Q = [...g]
          .sort((f, p) => p.locations.length - f.locations.length)
          .slice(0, 3)
          .map((f) => f.url);
        return g.filter((f) => Q.includes(f.url));
      },
      o = async (g) => {
        (t(1, (n = await g.data())),
          t(1, (n = a?.(n) ?? n)),
          t(2, (c = Object.entries(n.meta).filter(([I]) => !r.includes(I)))),
      ...
      d = (g = 30) => ". ".repeat(Math.floor(10 + Math.random() * g));
    return (
      (l.$$set = (g) => {
        ("show_images" in g && t(0, (s = g.show_images)),
          "process_result" in g && t(6, (a = g.process_result)),
          "result" in g && t(7, (i = g.result)));
      }),
      (l.$$.update = () => {
        l.$$.dirty & 128 && o(i);
      }),
  ...
  function Qs(l) {
    let e,
      ...
      a,
      i,
      r = S(Object.entries(l[1])),
      n = [];
    for (let c = 0; c < r.length; c += 1) n[c] = Fs(_s(l, r, c));
    return {
      c() {
        ((e = F("fieldset")), (t = F("legend")), (a = Z(s)), (i = X()));
      ...
      m(c, C) {
        (x(c, e, C), m(e, t), m(t, a), m(e, i));
        for (let u = 0; u < n.length; u += 1) n[u] && n[u].m(e, null);
      },
      p(c, C) {
        if (
          (C & 112 &&
            s !== (s = c[4]("filters_label", c[5], c[6]) + "") &&
            H(a, s),
          C & 143)
        ) {
          r = S(Object.entries(c[1]));
          let u;
    ...
    return {
      ...
      m(h, y) {
        (x(h, e, y),
          ...
          m(n, d),
          m(e, I),
          Q || ((f = M(t, "change", p)), (Q = !0)));
      },
      p(h, y) {
        ((l = h),
          y & 2 && s !== (s = l[10] + "-" + l[14]) && _(t, "id", s),
          y & 2 && a !== (a = l[10]) && _(t, "name", a),
          y & 2 && i !== (i = l[14]) && ((t.__value = i), ge(t, t.__value)),
          y & 3 && (t.checked = l[0][`${l[10]}:${l[14]}`]),
          y & 2 && C !== (C = l[14] + "") && c.p(C),
          y & 2 && A !== (A = l[15] + "") && H(o, A),
          y & 2 && g !== (g = l[10] + "-" + l[14]) && _(n, "for", g),
          y & 3 &&
            w(
              e,
              "pagefind-ui__filter-value--checked",
  ...
  function Fs(l) {
    let e,
      ...
      C,
      u,
      A = S(Object.entries(l[11] || {})),
      o = [];
    for (let d = 0; d < A.length; d += 1) o[d] = fs(bs(l, A, d));
    return {
      c() {
        ((e = F("details")),
          (t = F("summary")),
        ...
        ((C = X()),
          ...
          _(r, "class", "pagefind-ui__filter-group-label svelte-1v2r7ls"),
          _(i, "class", "pagefind-ui__filter-group svelte-1v2r7ls"),
      ...
      m(d, g) {
        (x(d, e, g),
          ...
          (r.innerHTML = n),
          m(i, c));
        for (let I = 0; I < o.length; I += 1) o[I] && o[I].m(i, null);
        m(e, C);
      },
      p(d, g) {
        if (
          (g & 2 &&
            ...
            (t.innerHTML = s),
          g & 2 && n !== (n = d[10] + "") && (r.innerHTML = n),
          g & 7)
        ) {
          A = S(Object.entries(d[11] || {}));
          let I;
          for (I = 0; I < A.length; I += 1) {
            let Q = bs(d, A, I);
            o[I] ? o[I].p(Q, g) : ((o[I] = fs(Q)), o[I].c(), o[I].m(i, null));
          }
  ...
  function fa(l) {
    ...
    return {
      ...
      p(a, [i]) {
        (i & 2 && (e = a[1] && Object.entries(a[1]).length),
          e
            ? s
              ? s.p(a, i)
              : ((s = Qs(a)), s.c(), s.m(t.parentNode, t))
            : s && (s.d(1), (s = null)));
      },
      i: W,
      o: W,
    ...
    return (
      (l.$$set = (d) => {
        ("available_filters" in d && t(1, (s = d.available_filters)),
          ...
          "translate" in d && t(4, (r = d.translate)),
          "automatic_translations" in d && t(5, (n = d.automatic_translations)),
          "translations" in d && t(6, (c = d.translations)),
  ...
  var pa = "Jan Claasen <jan@cloudcannon.com>",
    ...
    Ua = { thanks_to: pa, comments: Ba, direction: xa, strings: ha };
  var Rt = {};
  U(Rt, {
    comments: () => Xa,
    default: () => Ea,
  ...
  var ya = "Jermanuts",
    ...
    Ea = { thanks_to: ya, comments: Xa, direction: Za, strings: Na };
  var St = {};
  U(St, {
    comments: () => ka,
    default: () => Ha,
  ...
  var Ga = "Maruf Alom <mail@marufalom.com>",
    ka = "",
    La = "ltr",
    Wa = {
      placeholder:
    ...
    Ha = { thanks_to: Ga, comments: ka, direction: La, strings: Wa };
  var Vt = {};
  U(Vt, {
    comments: () => Sa,
    default: () => Ja,
  ...
  var Ra = "Pablo Villaverde <https://github.com/pvillaverde>",
    Sa = "",
    Va = "ltr",
    Da = {
      placeholder: "Cerca",
    ...
    Ja = { thanks_to: Ra, comments: Sa, direction: Va, strings: Da };
  var Dt = {};
  U(Dt, {
    comments: () => Ta,
    default: () => wa,
  ...
  var va = "Dalibor Hon <https://github.com/dallyh>",
    Ta = "",
    Ya = "ltr",
    Ma = {
      placeholder: "Hledat",
    ...
    wa = { thanks_to: va, comments: Ta, direction: Ya, strings: Ma };
  var Jt = {};
  U(Jt, {
    comments: () => Oa,
    default: () => Pa,
  ...
  var za = "Jonas Smedegaard <dr@jones.dk>",
    Oa = "",
    ja = "ltr",
    Ka = {
      placeholder: "S\xF8g",
    ...
    Pa = { thanks_to: za, comments: Oa, direction: ja, strings: Ka };
  var vt = {};
  U(vt, {
    comments: () => $a,
    default: () => li,
  ...
  var qa = "Jan Claasen <jan@cloudcannon.com>",
    ...
    li = { thanks_to: qa, comments: $a, direction: ei, strings: ti };
  var Tt = {};
  U(Tt, {
    comments: () => ai,
    default: () => ni,
  ...
  var si = "George Papadopoulos",
    ...
    ni = { thanks_to: si, comments: ai, direction: ii, strings: ri };
  var Yt = {};
  U(Yt, {
    comments: () => gi,
    default: () => Ci,
  ...
  var ci = "Liam Bigelow <liam@cloudcannon.com>",
    gi = "",
    oi = "ltr",
    ui = {
      placeholder: "Search",
    ...
    Ci = { thanks_to: ci, comments: gi, direction: oi, strings: ui };
  var Mt = {};
  U(Mt, {
    comments: () => di,
    default: () => bi,
  ...
  var Ii = "Pablo Villaverde <https://github.com/pvillaverde>",
    di = "",
    Ai = "ltr",
    _i = {
      placeholder: "Buscar",
    ...
    bi = { thanks_to: Ii, comments: di, direction: Ai, strings: _i };
  var wt = {};
  U(wt, {
    comments: () => mi,
    default: () => pi,
  ...
  var Qi = "Mikel Larreategi <mlarreaegi@codesyntax.com>",
    mi = "",
    fi = "ltr",
    Fi = {
      placeholder: "Bilatu",
    ...
    pi = { thanks_to: Qi, comments: mi, direction: fi, strings: Fi };
  var zt = {};
  U(zt, {
    comments: () => xi,
    default: () => yi,
  ...
  var Bi = "Ali Khaleqi Yekta <https://yekta.dev>",
    xi = "",
    hi = "rtl",
    Ui = {
      placeholder: "\u062C\u0633\u062A\u062C\u0648",
    ...
    yi = { thanks_to: Bi, comments: xi, direction: hi, strings: Ui };
  var Ot = {};
  U(Ot, {
    comments: () => Zi,
    default: () => Gi,
  ...
  var Xi = "Valtteri Laitinen <dev@valtlai.fi>",
    Zi = "",
    Ni = "ltr",
    Ei = {
      placeholder: "Haku",
    ...
    Gi = { thanks_to: Xi, comments: Zi, direction: Ni, strings: Ei };
  var jt = {};
  U(jt, {
    comments: () => Li,
    default: () => Ri,
  ...
  var ki = "Nicolas Friedli <nicolas@theologique.ch>",
    Li = "",
    Wi = "ltr",
    Hi = {
    ...
    Ri = { thanks_to: ki, comments: Li, direction: Wi, strings: Hi };
  var Kt = {};
  U(Kt, {
    comments: () => Vi,
    default: () => vi,
  ...
  var Si = "Pablo Villaverde <https://github.com/pvillaverde>",
    Vi = "",
    Di = "ltr",
    Ji = {
      placeholder: "Buscar",
    ...
    vi = { thanks_to: Si, comments: Vi, direction: Di, strings: Ji };
  var Pt = {};
  U(Pt, {
    comments: () => Yi,
    default: () => zi,
  ...
  var Ti = "Nir Tamir <nirtamir2@gmail.com>",
    Yi = "",
    Mi = "rtl",
    wi = {
      placeholder: "\u05D7\u05D9\u05E4\u05D5\u05E9",
    ...
    zi = { thanks_to: Ti, comments: Yi, direction: Mi, strings: wi };
  var qt = {};
  U(qt, {
    comments: () => ji,
    default: () => qi,
  ...
  var Oi = "Amit Yadav <amit@thetechbasket.com>",
    ji = "",
    Ki = "ltr",
    Pi = {
      placeholder: "\u0916\u094B\u091C\u0947\u0902",
    ...
    qi = { thanks_to: Oi, comments: ji, direction: Ki, strings: Pi };
  var $t = {};
  U($t, {
    comments: () => er,
    default: () => sr,
  ...
  var $i = "Diomed <https://github.com/diomed>",
    er = "",
    tr = "ltr",
    lr = {
      placeholder: "Tra\u017Ei",
    ...
    sr = { thanks_to: $i, comments: er, direction: tr, strings: lr };
  var el = {};
  U(el, {
    comments: () => ir,
    default: () => cr,
  ...
  var ar = "Adam Laki <info@adamlaki.com>",
    ir = "",
    rr = "ltr",
    nr = {
    ...
    cr = { thanks_to: ar, comments: ir, direction: rr, strings: nr };
  var tl = {};
  U(tl, {
    comments: () => or,
    default: () => Ir,
  ...
  var gr = "Nixentric",
    ...
    Ir = { thanks_to: gr, comments: or, direction: ur, strings: Cr };
  var ll = {};
  U(ll, {
    comments: () => Ar,
    default: () => Qr,
  ...
  var dr = "Cosette Bruhns Alonso, Andrew Janco <apjanco@upenn.edu>",
    Ar = "",
    _r = "ltr",
    br = {
      placeholder: "Cerca",
    ...
    Qr = { thanks_to: dr, comments: Ar, direction: _r, strings: br };
  var sl = {};
  U(sl, {
    comments: () => fr,
    default: () => Br,
  ...
  var mr = "Tate",
    ...
    Br = { thanks_to: mr, comments: fr, direction: Fr, strings: pr };
  var al = {};
  U(al, {
    comments: () => hr,
    default: () => Xr,
  ...
  var xr = "Seokho Son <https://github.com/seokho-son>",
    hr = "",
    Ur = "ltr",
    yr = {
      placeholder: "\uAC80\uC0C9\uC5B4",
    ...
    Xr = { thanks_to: xr, comments: hr, direction: Ur, strings: yr };
  var il = {};
  U(il, {
    comments: () => Nr,
    default: () => kr,
  ...
  var Zr = "",
    ...
    kr = { thanks_to: Zr, comments: Nr, direction: Er, strings: Gr };
  var rl = {};
  U(rl, {
    comments: () => Wr,
    default: () => Sr,
  ...
  var Lr = "Harry Min Khant <https://harrymkt.github.io>",
    Wr = "",
    Hr = "ltr",
    Rr = {
      placeholder: "\u101B\u103E\u102C\u101B\u1014\u103A",
    ...
    Sr = { thanks_to: Lr, comments: Wr, direction: Hr, strings: Rr };
  var nl = {};
  U(nl, {
    comments: () => Dr,
    default: () => Tr,
  ...
  var Vr = "Eirik Mikkelsen",
    ...
    Tr = { thanks_to: Vr, comments: Dr, direction: Jr, strings: vr };
  var cl = {};
  U(cl, {
    comments: () => Mr,
    default: () => Or,
  ...
  var Yr = "Paul van Brouwershaven",
    ...
    Or = { thanks_to: Yr, comments: Mr, direction: wr, strings: zr };
  var gl = {};
  U(gl, {
    comments: () => Kr,
    default: () => $r,
  ...
  var jr = "Eirik Mikkelsen",
    ...
    $r = { thanks_to: jr, comments: Kr, direction: Pr, strings: qr };
  var ol = {};
  U(ol, {
    comments: () => tn,
    default: () => an,
  ...
  var rn = "",
    ...
    on = { thanks_to: rn, comments: nn, direction: cn, strings: gn };
  var Cl = {};
  U(Cl, {
    comments: () => Cn,
    default: () => An,
  ...
  var _n = "Bogdan Mateescu <bogdan@surfverse.com>",
    ...
    fn = { thanks_to: _n, comments: bn, direction: Qn, strings: mn };
  var dl = {};
  U(dl, {
    comments: () => pn,
    default: () => hn,
  ...
  var Fn = "Aleksandr Gordeev",
    ...
    hn = { thanks_to: Fn, comments: pn, direction: Bn, strings: xn };
  var Al = {};
  U(Al, {
    comments: () => yn,
    default: () => Nn,
  ...
  var Un = "Andrija Sagicc",
    ...
    Nn = { thanks_to: Un, comments: yn, direction: Xn, strings: Zn };
  var _l = {};
  U(_l, {
    comments: () => Gn,
    default: () => Wn,
  ...
  var En = "Montazar Al-Jaber <montazar@nanawee.tech>",
    ...
    Wn = { thanks_to: En, comments: Gn, direction: kn, strings: Ln };
  var bl = {};
  U(bl, {
    comments: () => Rn,
    default: () => Dn,
  ...
  var Hn = "Anonymous",
    ...
    Dn = { thanks_to: Hn, comments: Rn, direction: Sn, strings: Vn };
  var Ql = {};
  U(Ql, {
    comments: () => vn,
    default: () => Mn,
  ...
  var Jn = "",
    ...
    Mn = { thanks_to: Jn, comments: vn, direction: Tn, strings: Yn };
  var ml = {};
  U(ml, {
    comments: () => zn,
    default: () => Kn,
  ...
  var wn = "Patiphon Loetsuthakun <ptphon@gmail.com>",
    ...
    Kn = { thanks_to: wn, comments: zn, direction: On, strings: jn };
  var fl = {};
  U(fl, {
    comments: () => qn,
    default: () => tc,
  ...
  var Pn = "Taylan \xD6zg\xFCr Bildik",
    ...
    tc = { thanks_to: Pn, comments: qn, direction: $n, strings: ec };
  var Fl = {};
  U(Fl, {
    comments: () => sc,
    default: () => rc,
  ...
  var lc = "Vladyslav Lyshenko <vladdnepr1989@gmail.com>",
    sc = "",
    ac = "ltr",
    ic = {
      placeholder: "\u041F\u043E\u0448\u0443\u043A",
    ...
    rc = { thanks_to: lc, comments: sc, direction: ac, strings: ic };
  var pl = {};
  U(pl, {
    comments: () => cc,
    default: () => uc,
  ...
  var nc = "Long Nhat Nguyen",
    ...
    uc = { thanks_to: nc, comments: cc, direction: gc, strings: oc };
  var Bl = {};
  U(Bl, {
    comments: () => Ic,
    default: () => _c,
  ...
  var Cc = "Amber Song",
    ...
    _c = { thanks_to: Cc, comments: Ic, direction: dc, strings: Ac };
  var xl = {};
  U(xl, {
    comments: () => Qc,
    default: () => Fc,
  ...
  var bc = "Amber Song",
    ...
    Fc = { thanks_to: bc, comments: Qc, direction: mc, strings: fc };
  var hl = {};
  U(hl, {
    comments: () => Bc,
    default: () => Uc,
  ...
  var pc = "Amber Song",
    ...
    Uc = { thanks_to: pc, comments: Bc, direction: xc, strings: hc };
  var yc = [
      Ht,
      Rt,
      St,
  ...
  function Xs(l) {
    ...
    return (
      l[0] !== void 0 && (i.selected_filters = l[0]),
      (e = new xs({ props: i })),
      Ce.push(() => Ol(e, "selected_filters", a)),
      {
        ...
        p(r, n) {
          let c = {};
          (n[0] & 32 && (c.show_empty_filters = r[5]),
            n[0] & 64 && (c.open_filters = r[6]),
            n[0] & 262144 && (c.available_filters = r[18]),
            n[0] & 524288 && (c.automatic_translations = r[19]),
            n[0] & 128 && (c.translations = r[7]),
            !t &&
              n[0] & 1 &&
              ((t = !0), (c.selected_filters = r[0]), Yl(() => (t = !1))),
            e.$set(c));
        },
        i(r) {
          s || (k(e.$$.fragment, r), (s = !0));
        },
        o(r) {
          (V(e.$$.fragment, r), (s = !1));
        },
  ...
  function Zc(l) {
    ...
    let g = l[13].results.length > l[17] && Es(l);
    return {
      c() {
        ((e = F("p")), A.c(), (t = X()), (s = F("ol")));
      ...
      m(I, Q) {
        (x(I, e, Q), A.m(e, null), x(I, t, Q), x(I, s, Q));
        for (let f = 0; f < a.length; f += 1) a[f] && a[f].m(s, null);
        (x(I, r, Q), g && g.m(I, Q), x(I, n, Q), (c = !0));
      },
      p(I, Q) {
        (u === (u = C(I, Q)) && A
          ? A.p(I, Q)
          ...
          Q[0] & 139292 &&
            ((o = S(I[13].results.slice(0, I[17]))),
            ie(),
            (a = zl(a, Q, d, 1, I, o, i, s, wl, Ns, null, ys)),
            re()),
          I[13].results.length > I[17]
            ? g
              ? g.p(I, Q)
              : ((g = Es(I)), g.c(), g.m(n.parentNode, n))
            : g && (g.d(1), (g = null)));
      },
      i(I) {
        if (!c) {
          for (let Q = 0; Q < o.length; Q += 1) k(a[Q]);
          c = !0;
        }
      },
      o(I) {
        for (let Q = 0; Q < a.length; Q += 1) V(a[Q]);
        c = !1;
      },
      d(I) {
        (I && (B(e), B(t), B(s), B(r), B(n)), A.d());
        for (let Q = 0; Q < a.length; Q += 1) a[Q].d();
        g && g.d(I);
      },
    };
  }
  ...
  function Lc(l) {
    ...
    return (
      ...
      })),
      {
        ...
        p(s, a) {
          let i = {};
          (a[0] & 4 && (i.show_images = s[2]),
            a[0] & 16 && (i.process_result = s[4]),
            a[0] & 139264 && (i.result = s[53]),
            e.$set(i));
        },
        i(s) {
  ...
  function Ns(l, e) {
    ...
    return (
      ...
      (a = c[s] = n[s](e)),
      {
        ...
        first: null,
        c() {
          ((t = ee()), a.c(), (i = ee()), (this.first = t));
        },
        m(u, A) {
          (x(u, t, A), c[s].m(u, A), x(u, i, A), (r = !0));
        },
        p(u, A) {
          e = u;
          let o = s;
  ...
  function Es(l) {
    ...
    return {
      ...
      m(r, n) {
        (x(r, e, n), m(e, s), a || ((i = M(e, "click", l[22])), (a = !0)));
      },
      p(r, n) {
        n[0] & 524416 &&
          t !== (t = r[20]("load_more", r[19], r[7]) + "") &&
          H(s, t);
      },
      d(r) {
        (r && B(e), (a = !1), i());
  ...
  function Hc(l) {
    ...
    return {
      ...
      p(h, y) {
        ((!g ||
          (y[0] & 524416 && a !== (a = h[20]("placeholder", h[19], h[7])))) &&
          _(s, "placeholder", a),
          (!g ||
            (y[0] & 524416 && i !== (i = h[20]("placeholder", h[19], h[7])))) &&
            _(s, "title", i),
          (!g || y[0] & 256) && (s.autofocus = h[8]),
          y[0] & 512 && s.value !== h[9] && ge(s, h[9]),
          (!g || y[0] & 524416) &&
            c !== (c = h[20]("clear_search", h[19], h[7]) + "") &&
            H(C, c),
          (!g || y[0] & 512) && w(n, "pagefind-ui__suppressed", !h[9]),
          h[12]
            ? f
              ? (f.p(h, y), y[0] & 4096 && k(f, 1))
              : ((f = Xs(h)), f.c(), k(f, 1), f.m(A, o))
            : f &&
              (ie(),
              V(f, 1, 1, () => {
                f = null;
          ...
          h[15]
            ? p
              ? (p.p(h, y), y[0] & 32768 && k(p, 1))
              : ((p = Zs(h)), p.c(), k(p, 1), p.m(A, null))
            : p &&
              (ie(),
              V(p, 1, 1, () => {
                p = null;
              ...
              re()),
          (!g || y[0] & 32768) && w(A, "pagefind-ui__hidden", !h[15]),
          (!g ||
            (y[0] & 524416 &&
              d !== (d = h[20]("search_label", h[19], h[7])))) &&
            _(t, "aria-label", d),
          (!g || y[0] & 2) && w(e, "pagefind-ui--reset", h[1]));
      },
      i(h) {
        g || (k(f), k(p), (g = !0));
      },
  ...
  var Rc = (l) => l.preventDefault();
  function Sc(l, e, t) {
    let s = {},
      a = Us.map((b) => b.match(/([^\/]+)\.json$/)[1]);
    for (let b = 0; b < a.length; b++)
      s[a[b]] = { language: a[b], ...hs[b].strings };
    let { base_path: i = "/pagefind/" } = e,
      { page_size: r = 5 } = e,
      { reset_styles: n = !0 } = e,
      { show_images: c = !0 } = e,
        ...
        let E = document.activeElement,
          L =
            ...
            (E.tagName === "INPUT" ||
              E.tagName === "TEXTAREA" ||
              E.isContentEditable);
        b.key === "/" && !L && (b.preventDefault(), J?.focus());
      };
    (Ut(() => {
      let b = document?.querySelector?.("html")?.getAttribute?.("lang") || "en",
        E = bt(b.toLocaleLowerCase());
      (t(
        19,
        (Gl =
          s[`${E.language}-${E.script}-${E.region}`] ||
          s[`${E.language}-${E.region}`] ||
          s[`${E.language}`] ||
          s.en),
      ),
...
`),
          ...
          u || t(24, (u = C ? 12 : 30));
          let E = { ...(Q || {}), excerptLength: u };
          await b.options(E);
          for (let L of f) {
            if (!L.bundlePath)
              throw new Error("mergeIndex requires a bundlePath parameter");
            let Y = L.bundlePath;
            (delete L.bundlePath, await b.mergeIndex(Y, L));
          }
          ((G = b), Hs());
        }
      },
      Hs = async () => {
        G &&
          ((El = await G.filters()),
          (!Ie || !Object.keys(Ie).length) && t(18, (Ie = El)));
      },
      Rs = (b) => {
        let E = {};
        return (
      ...
      Ss = async (b, E) => {
        ...
        (I > 0 && b
          ? (de && clearTimeout(de),
            (de = setTimeout(Y, I)),
            await Wl(),
            G.preload(b, { filters: L }))
          : Y(),
          Ds());
      },
      Wl = async () => {
        for (; !G; ) (Ll(), await new Promise((b) => setTimeout(b, 50)));
      },
      Vs = async (b, E) => {
        (t(16, (Nl = b || "")),
          typeof o == "function" && (b = o(b)),
          t(14, (ft = !0)),
          t(15, (Ft = !0)),
          await Wl());
        let L = ++Zl,
          Y = { filters: E };
        z && typeof z == "object" && (Y.sort = z);
        let ne = await G.search(b, Y);
        Zl === L &&
          (ne.filters &&
      ...
      Ds = () => {
        let b = ct.offsetWidth;
        b != Ls && t(10, (J.style.paddingRight = `${b + 2}px`), J);
      },
      Js = (b) => {
        (b?.preventDefault(), t(17, (pt += r)));
      },
      vs = (b) => {
        (b.key === "Escape" && (t(9, (R = "")), J.blur()),
          b.key === "Enter" && b.preventDefault());
      };
    function Ts() {
      ((R = this.value), t(9, R), t(23, p));
    }
    function Ys(b) {
      Ce[b ? "unshift" : "push"](() => {
        ((J = b), t(10, J));
    ...
    return (
      (l.$$set = (b) => {
        ("base_path" in b && t(25, (i = b.base_path)),
          "page_size" in b && t(26, (r = b.page_size)),
          "reset_styles" in b && t(1, (n = b.reset_styles)),
          "show_images" in b && t(2, (c = b.show_images)),
          "show_sub_results" in b && t(3, (C = b.show_sub_results)),
          "excerpt_length" in b && t(24, (u = b.excerpt_length)),
          "process_result" in b && t(4, (A = b.process_result)),
          "process_term" in b && t(27, (o = b.process_term)),
          "show_empty_filters" in b && t(5, (d = b.show_empty_filters)),
          "open_filters" in b && t(6, (g = b.open_filters)),
          "debounce_timeout_ms" in b && t(28, (I = b.debounce_timeout_ms)),
          "pagefind_options" in b && t(29, (Q = b.pagefind_options)),
          "merge_index" in b && t(30, (f = b.merge_index)),
          "trigger_search_term" in b && t(23, (p = b.trigger_search_term)),
          "translations" in b && t(7, (h = b.translations)),
          "autofocus" in b && t(8, (y = b.autofocus)),
          "focus_on_slash" in b && t(31, (q = b.focus_on_slash)),
          "sort" in b && t(32, (z = b.sort)),
          "selected_filters" in b && t(0, (N = b.selected_filters)));
      }),
      (l.$$.update = () => {
        (l.$$.dirty[0] & 8388608 && p && (t(9, (R = p)), t(23, (p = ""))),
          l.$$.dirty[0] & 513 && Ss(R, N));
      }),
      [
        N,
        n,
  ...
  var Qt = class {
    constructor(e) {
      ...
      (delete e.element,
        ...
        delete e.sort);
      let h = t instanceof HTMLElement ? t : document.querySelector(t);
      h
        ? (this._pfs = new ks({
            target: h,
            props: {
    ...
    triggerFilters(e) {
      ...
      for (let [s, a] of Object.entries(e))
        if (Array.isArray(a)) for (let i of a) t[`${s}:${i}`] = !0;
        else t[`${s}:${a}`] = !0;
